...
<body class="bg_Img imgPatio">
    ...
    <main>
        ...
        <div class="font-img">
            <a href="introLaLiberacionDelAgua.html">
                <img src="../media/img_fuentes/fuente_roja.png" alt="fuente_roja" class="fuente_roja" id="fuenteRoja">
            </a>
        </div>

        <!--Div de la fuente verde-->
        <div class= "font-img">
            <a href="introRescateDelMar.html">
                <img src="../media/img_fuentes/fuente_verde.png" alt="fuente_verde" class="fuente_verde"id="fuenteVerde">
            </a>
        </div>
